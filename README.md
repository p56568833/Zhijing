...
- 编辑 / Markdown 阅读模式
- 选中文字可添加荧光、重要、概念或下划线标记；编辑器始终收起标记语法，标记文字直接以颜色样式显示，全选也不会露出语法，源文仍保留为可读的 Markdown
- 选中文字后在选区旁直接写批注，批注作为 Markdown 块保存在正文中；编辑器里批注块折叠为标题和内容两行，正文锚点画红色波浪线并配 ①② 编号与批注块对应，阅读模式里原文节选缩短显示
